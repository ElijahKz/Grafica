...
public class Tools2
{
    ...
    public static String convertirColaAHtml(Cola<Valor> p)
    {
        StringBuilder sb = new StringBuilder("<html>");
        Cola<Valor> q = OperacionesCola.clonar(p);
        ...
        {
            sb.append("<h1 align=\"center\">").append("¡¡¡Pila Vacia o Cola Vacía!!!").append("</h1>");
        }
    ...
    public static String convertirColaAHtml(Cola<Valor> p, String texto)
    {
